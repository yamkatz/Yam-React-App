...
const CounterActionsPage = () => {
  ...
  const handleClicMinuskNumber = () => {
    dispatch(counterActions.minus(txt));
  };
  const handleMinus1Click = () => {
    dispatch(counterActions.minus1());
  };
  ...
  return (
    <Fragment>
      ...
      <Button onClick={handleMinus1Click}>minus 1</Button>
      <Button onClick={handleClicMinuskNumber}>minus</Button>
    </Fragment>
  );
};
